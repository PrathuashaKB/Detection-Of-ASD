...
<div>
  <p align="center">
    <img src="https://github.com/PrathuashaKB/Detection-Of-ASD/blob/main/images/ASD%20Detection%20Logo.png" width="800"> 
  </p>
</div>
...
![Keras](https://img.shields.io/badge/Keras-DL-red?style=flat&logo=keras&logoColor=white)
![Scikit-learn](https://img.shields.io/badge/Scikit--learn-ML-blue?style=flat&logo=scikitlearn&logoColor=white)
![OpenCV](https://img.shields.io/badge/OpenCV-CV-green?style=flat&logo=opencv&logoColor=white)
![Pandas](https://img.shields.io/badge/Pandas-Data--Analysis-black?style=flat&logo=pandas)
![NumPy](https://img.shields.io/badge/NumPy-Arrays-purple?style=flat&logo=numpy)
![Matplotlib](https://img.shields.io/badge/Matplotlib-Plotting-orange?style=flat&logo=plotly)
![Seaborn](https://img.shields.io/badge/Seaborn-Stats%20Viz-teal?style=flat)
![PIL](https://img.shields.io/badge/PIL-Image--Processing-yellow?style=flat)
...
[PROJECT PRESENTATION](https://github.com/PrathuashaKB/Detection-Of-ASD/blob/main/Project%20Presentation.pptx), you can find the complete project presentation here.
...
![CNN](https://img.shields.io/badge/CNN-Deep--Learning-informational?style=flat)
...
![Logistic Regression](https://img.shields.io/badge/Logistic--Regression-ML-green?style=flat)
![XGBoost](https://img.shields.io/badge/XGBoost-Classifier-orange?style=flat&logo=xgboost)
![SVC](https://img.shields.io/badge/SVM--SVC-Classifier-purple?style=flat)
